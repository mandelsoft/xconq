...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.7OCB47>
...
# operating system:  Linux 5.15.0-139-generic x86_64 [ELF] (5.15.0)
# libc:	(6.31.0)
# binutils:	(234)
...
all:: $(PROGRAM1).$(MANNEWSUFFIX)

$(PROGRAM1).$(MANNEWSUFFIX): $(PROGRAM1).$(MANSRCSUFFIX)
	$(RM) $@
	if test -z "$(PREPROCESSMANPAGES)" ; then \
	   cd `dirname $(PROGRAM1)` && \
	   $(LN) `basename $(PROGRAM1).$(MANSRCSUFFIX)` `basename $@`; \
	else \
	      	     $(RAWCPP)  $(MANDEFS) $(EXTRAMANDEFS) \
	     < $(PROGRAM1).$(MANSRCSUFFIX) | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' 			-e '/^#line  *[0-9][0-9]*  *.*$$/d' 			-e '/^[ 	]*XCOMM$$/s/XCOMM/#/' 			-e '/^[ 	]*XCOMM[^a-zA-Z0-9_]/s/XCOMM/#/' 			-e '/^[ 	]*XHASH/s/XHASH/#/' 			-e '/\@\@$$/s/\@\@$$/\\/' >$@; \
	fi

cleandir::
	$(RM) $(PROGRAM1).$(MANNEWSUFFIX)

install.man:: $(PROGRAM1).$(MANNEWSUFFIX)
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) $(PROGRAM1).$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/$(PROGRAM1).$(MANSUFFIX)
...
all:: $(PROGRAM2).$(MANNEWSUFFIX)

$(PROGRAM2).$(MANNEWSUFFIX): $(PROGRAM2).$(MANSRCSUFFIX)
	$(RM) $@
	if test -z "$(PREPROCESSMANPAGES)" ; then \
	   cd `dirname $(PROGRAM2)` && \
	   $(LN) `basename $(PROGRAM2).$(MANSRCSUFFIX)` `basename $@`; \
	else \
	      	     $(RAWCPP)  $(MANDEFS) $(EXTRAMANDEFS) \
	     < $(PROGRAM2).$(MANSRCSUFFIX) | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' 			-e '/^#line  *[0-9][0-9]*  *.*$$/d' 			-e '/^[ 	]*XCOMM$$/s/XCOMM/#/' 			-e '/^[ 	]*XCOMM[^a-zA-Z0-9_]/s/XCOMM/#/' 			-e '/^[ 	]*XHASH/s/XHASH/#/' 			-e '/\@\@$$/s/\@\@$$/\\/' >$@; \
	fi

cleandir::
	$(RM) $(PROGRAM2).$(MANNEWSUFFIX)

install.man:: $(PROGRAM2).$(MANNEWSUFFIX)
	@if [ -d $(DESTDIR)$(MANDIR) ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(MANDIR) ]; then \
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) $(PROGRAM2).$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/$(PROGRAM2).$(MANSUFFIX)
...
install:: ./lib
	@if [ -d $(XCONQLIB) ]; then \
		...
		(set -x; $(MKDIRHIER) $(XCONQLIB)); \
	fi
	for i in `ls lib`; do (set -x; 		$(INSTALL) -c $(INSTDATFLAGS) ./lib/$$i $(XCONQLIB)); done
...
xconq.pcf.gz:  xconq.bdf
	$(FONTC) $(FONTCFLAGS) $? | $(GZIPCMD) > $@

standard.pcf.gz:  standard.bdf
	$(FONTC) $(FONTCFLAGS) $? | $(GZIPCMD) > $@
...
install:: $(OBJS)
	@if [ -d $(DESTDIR)$(FONTDIR)/xconq ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(FONTDIR)/xconq ]; then \
			(set -x; rm -f $(DESTDIR)$(FONTDIR)/xconq); \
		fi; \
		(set -x; $(MKDIRHIER) $(DESTDIR)$(FONTDIR)/xconq); \
	fi
...
install::
	...
	@if [ X$(STATIC_FONTS_SCALE) = X ]; then (set -x; \
	  $(RM) $(DESTDIR)$(FONTDIR)/xconq/fonts.scale; \
	  $(MKFONTSCALE)  $(DESTDIR)$(FONTDIR)/xconq); \
	else (set -x; \
	  $(INSTALL) $(INSTALLFLAGS) $(INSTDATFLAGS) fonts.scale $(DESTDIR)$(FONTDIR)/xconq/fonts.scale); \
	fi
	$(RM) $(DESTDIR)$(FONTDIR)/xconq/fonts.dir
	$(MKFONTDIR)  $(MKFONTDIROPTS) $(DESTDIR)$(FONTDIR)/xconq
...
# DO NOT DELETE
xconq.o: xconq.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h global.h version.h
init.o: init.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/endianness.h \
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h
command.o: command.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h mplay.h
mplay.o: mplay.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h mplay.h
mutil.o: mutil.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h mplay.h
mproduce.o: mproduce.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h mplay.h
mvars.o: mvars.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 unit.h side.h mplay.h
sergeant.o: sergeant.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h
move.o: move.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h
minit.o: minit.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h mplay.h
attack.o: attack.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h global.h
phases.o: phases.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h
map.o: map.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h
mkmap.o: mkmap.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 dir.h map.h
side.o: side.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
...
unit.o: unit.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h global.h
order.o: order.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h global.h map.h
util.o: util.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/endianness.h \
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h map.h
input.o: input.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h global.h map.h
help.o: help.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h
period.o: period.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h
ginit.o: ginit.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h dir.h \
 period.h side.h unit.h map.h global.h
draw.o: draw.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
...
output.o: output.c /usr/include/stdc-predef.h config.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h global.h
standard.o: standard.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/endianness.h \
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h period.h
X11.o: X11.c /usr/include/stdc-predef.h config.h /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 /usr/include/x86_64-linux-gnu/bits/long-double.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 side.h unit.h map.h global.h /usr/include/X11/Xos.h \
 ...
 /usr/include/X11/Xarch.h /usr/include/signal.h \
 ...
 /usr/include/X11/Xresource.h /usr/include/X11/Intrinsic.h \
 /usr/include/X11/Core.h /usr/include/X11/Composite.h \
 /usr/include/X11/Constraint.h /usr/include/X11/Object.h \
 /usr/include/X11/RectObj.h /usr/include/x86_64-linux-gnu/sys/socket.h \
...
standard.o: standard.c /usr/include/stdc-predef.h config.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h period.h
curses.o: curses.c /usr/include/stdc-predef.h config.h \
 /usr/include/stdio.h \
 /usr/include/x86_64-linux-gnu/bits/libc-header-start.h \
 /usr/include/features.h /usr/include/x86_64-linux-gnu/sys/cdefs.h \
 /usr/include/x86_64-linux-gnu/bits/wordsize.h \
 ...
 /usr/include/x86_64-linux-gnu/bits/types/locale_t.h \
 /usr/include/x86_64-linux-gnu/bits/types/__locale_t.h misc.h period.h \
 global.h side.h map.h /usr/include/curses.h /usr/include/ncurses_dll.h \
